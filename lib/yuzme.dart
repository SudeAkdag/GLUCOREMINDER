...
class _YuzmeSayfasiState extends State<YuzmeSayfasi>with TickerProviderStateMixin
   {
...
Future<void> _kontrolVeSifirla() async {
  ...
  final docRef = FirebaseFirestore.instance.collection('yuzme_verileri').doc(tarihKey);
